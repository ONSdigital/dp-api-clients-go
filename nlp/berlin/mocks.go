...
type ClienterMock struct {
	...
	calls struct {
		...
		// GetBerlin holds details about calls to the GetBerlin method.
		GetBerlin []struct {
			// Ctx is the ctx argument value.
			Ctx context.Context
...
func (mock *ClienterMock) GetBerlin(ctx context.Context, options Options) (*models.Berlin, errors.Error) {
	if mock.GetBerlinFunc == nil {
		panic("ClienterMock.GetBerlinFunc: method is nil but Clienter.GetBerlin was just called")
	}
	callInfo := struct {
		Ctx     context.Context
		Options Options
	...
	mock.lockGetBerlin.Lock()
	mock.calls.GetBerlin = append(mock.calls.GetBerlin, callInfo)
	mock.lockGetBerlin.Unlock()
	return mock.GetBerlinFunc(ctx, options)
}

// GetBerlinCalls gets all the calls that were made to GetBerlin.
// Check the length with:
//
...
func (mock *ClienterMock) GetBerlinCalls() []struct {
	...
	mock.lockGetBerlin.RLock()
	calls = mock.calls.GetBerlin
	mock.lockGetBerlin.RUnlock()
	return calls
}
